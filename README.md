# 🚀 WhatsApp Automation Hub 24/7 (Android + iOS Universal)

Plataforma multifuncional de automatización de WhatsApp en la nube, 100% compatible con dispositivos **Android** e **iOS (iPhone)**, construida sobre **Node.js 20**, **@whiskeysockets/baileys**, **Express**, **Socket.io**, **Groq Whisper AI** y empacada en **Docker** para despliegue continuo 24/7 en **Render.com**.

---

## 📌 Visión General del Sistema
Este bot actúa como un centro de control autónomo en la nube para cuentas de **WhatsApp** o **WhatsApp Business** en dispositivos **Android e iOS**. Se conecta mediante el protocolo nativo Multi-Device WebSocket de WhatsApp usando **Baileys**, lo que garantiza:
* **Compatibilidad Universal (Android + iOS)**: Vinculación perfecta desde WhatsApp Business o WhatsApp estándar en teléfonos Android, iPhone o computadores.
...
* **Motor WhatsApp**: `@whiskeysockets/baileys` (v6.7.5) con tupla `Browsers.ubuntu('Chrome')` para Android e iOS.
...
* **Interfaz de Usuario**: Dashboard Web Executive Full-Screen adaptable a pantallas táctiles Android (Chrome Mobile, Samsung Internet) e iOS (Safari).
...
- Intercepta notas de voz (`audioMessage`), procesa el audio con IA Whisper en español, responde automáticamente al mismo chat y lo añade al panel web.
...
## 🤖 Prompt Máster Universal para Claude Code / Cowork (Android + iOS)
...
Crea una aplicación independiente de WhatsApp Automation Hub 24/7 desplegable en Render o Docker, con compatibilidad UNIVERSAL para Android e iOS (iPhone).

REQUERIMIENTOS:
1. Usar @whiskeysockets/baileys (v6.7.5) con compatibilidad Multi-Device para WhatsApp en Android e iOS.
...
6. Interfaz Web Executive Full-Screen (100vw/100vh) adaptable a navegadores de Android (Chrome) e iOS (Safari).
